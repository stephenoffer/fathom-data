...
from ..adapters.fs import FileSystem, filesystem_for
from ..core.ids import AliasRegistry
...
from .events import IngestResult
...
class OpenLineageRun:
    ...
    def failed(self) -> bool:
        """True when the run did not complete successfully."""
