...
from ...core.ids import dataset_uri
...
from ...observe.profile import Profile, profile_parquet
...
class ObjectStorage:
    ...
    def list_objects(self, dataset: DatasetId) -> Iterable[ObjectMeta]:
        """Every data object under the prefix, markers excluded."""
        fs = self.filesystem(dataset)
    ...
    def paths(self, objects: Sequence[ObjectMeta]) -> list[str]:
        """URIs for these objects, in the order given."""
